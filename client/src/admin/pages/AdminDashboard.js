        ...
        try {
            ...
            const tempFilterData = data.filter(obj => {
                return (
                    ...
                    || (obj.ref && obj.ref.toLowerCase().includes(searchString.toLowerCase()))
                    || (obj.tel && obj.tel.toLowerCase().includes(searchString.toLowerCase()))
                    || (obj.telegram.username && obj.telegram.username.toLowerCase().includes(searchString.toLowerCase()))
                )
            })
